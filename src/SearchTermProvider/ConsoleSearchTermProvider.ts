...
export default class ConsoleSearchTermProvider implements ISearchTermProvider {
  ...
  async loadDynamicTerms() {
    const loadOrganisations = createDynamicLoader(
      "organisation",
      "/api/organisations",
      "id",
      createSearchTermType("name", "/Organisation/Index/?")
    );
    const loadAccounts = createDynamicLoader(
      "account",
      "/api/accounts",
      "id",
      createSearchTermType("licenseName", "/Account/Index/?")
    );
    const loadGroups = createDynamicLoader(
      "group",
      "/api/groups",
      "id",
      createSearchTermType("name", "/Group/Index/?")
    );
    const loadUsers = createDynamicLoader(
      "user",
      "/api/users",
      "id",
      createSearchTermType("name", "/User/Index/?")
    );
    const loadProfiles = createDynamicLoader(
      "profile",
      "/api/profiles",
      "id",
      createSearchTermType("name", "/Profile/Index/?")
    );
    const loadServers = createDynamicLoader(
      "server",
      "/api/servers",
      "id",
      createSearchTermType("name", "/Server/Index/?")
    );
    const loadRegions = createDynamicLoader(
      "region",
      "/api/regions",
      "id",
      createSearchTermType("name", "/Region/Index/?")
    );
    const loadSolutions = createDynamicLoader(
      "solution",
      "/api/solutions",
      "id",
      createSearchTermType("name", "/Solution/Index/?")
    );
